...
public class ManoObraMapperImpl implements ManoObraMapper {
    ...
    public ManoObra toEntity(ManoObraDto manoObraDto) {
        ...
        manoObra.setDuracionHs(Duration.ofHours(manoObraDto.getDuracionHs()));
    ...
    public ManoObraDto toDto(ManoObra manoObra) {
        ...
        if (manoObra.getDuracionHs() != null) {
            manoObraDto.setDuracionHs(manoObra.getDuracionHs().toHours());
        }
