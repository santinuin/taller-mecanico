...
public class LoadData {
    ...
    Optional<Empleado> crearEmpleadoRecep() {
    ...
    Optional<Empleado> crearEmpleadoAdmin() {
    ...
    Optional<Mecanico> crearMecanico() {
